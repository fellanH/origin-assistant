---
source: https://ai-sdk.dev/elements/components/speech-input
scraped: 2026-02-02T09:36:41.819Z
category: voice
---
...
- On stop, creates an audio blob (`audio/webm`)

- Calls `onAudioRecorded` with the blob

- Waits for transcription result

- Passes result to `onTranscriptionChange`
...
```
const handleAudioRecorded = async (audioBlob: Blob): Promisestring> => {
