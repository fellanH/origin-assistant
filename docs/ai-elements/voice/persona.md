---
source: https://ai-sdk.dev/elements/components/persona
scraped: 2026-02-02T09:36:41.472Z
category: voice
---
...
export default function App() {
  ...
  return (
    div>
      ...
      div>
        button onClick={startListening}>Listenbutton>
        button onClick={startThinking}>Thinkbutton>
        button onClick={startSpeaking}>Speakbutton>
