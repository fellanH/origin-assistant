...
scraped: 2026-02-02T09:36:29.200Z
category: examples
---
...
export default function Home() {
  ...
  const [currentChat, setCurrentChat] = useStateChat | null>(null);
    ...
    div className="h-screen flex">
      ...
      div className="w-1/2 flex flex-col border-r">
        ...
        div className="border-b p-3 h-14 flex items-center justify-between">
          h1 className="text-lg font-semibold">v0 Cloneh1>
        div>
...
You now have a working v0 clone you can build off of! Feel free to explore the [v0 Platform API](https://v0.dev/docs/api/platform) and components like [`Reasoning`](/elements/en/elements/components/reasoning) and [`Task`](/elements/en/elements/components/task) to extend your app, or view the other examples.