...
scraped: 2026-02-02T09:36:31.927Z
category: chatbot
---
...
Build citations for AI-generated content using [`experimental_generateObject`](/elements/en/docs/reference/ai-sdk-ui/use-object).
...
- **Footnote conversion**: GitHub Flavored Markdown (GFM) handles footnotes using `[^1]` syntax. You could hypothetically remove the default footnote rendering and convert footnotes to inline citations instead.

- **Custom HTML syntax**: You could add a system prompt instructing the model to use a special HTML syntax like `` and pass that as a custom component to Streamdown.
