...
scraped: 2026-02-02T09:36:35.720Z
category: chatbot
---
...
Build a simple stateful weather app that renders the last message in a tool using [`useChat`](/elements/en/docs/reference/ai-sdk-ui/use-chat).
