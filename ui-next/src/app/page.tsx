...
export default function ChatPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-background to-background/95 flex overflow-hidden">
      {/* Session Sidebar with header and input */}
      <SessionSidebar
        ref={sidebarRef}
        client={client}
        connected={connected}
      ...
      {showSettings && (
        <div className="absolute top-16 left-4 z-50 bg-card/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl p-5 w-80 animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        {(error || connectionError) && (
          <div className="mx-6 mt-4 p-4 bg-destructive/10 border border-destructive/20 rounded-xl text-destructive text-sm flex items-center gap-3 flex-shrink-0">
        ...
        <div className="flex-1 overflow-hidden">
          <Conversation className="h-full">
            <ConversationContent className="px-6 py-4 max-w-4xl mx-auto">
