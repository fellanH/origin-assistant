const DEFAULT_TAGLINE = "Your AI assistant, ready to help.";
...
const TAGLINES: string[] = [
  "Your terminal just got smarter—type something and let me handle the busywork.",
  ...
  "Automation done right: minimal fuss, maximal results.",
  ...
  "Ready to go—let's ship something mildly responsible.",
  "I'll streamline your workflow: efficient, effective, elegant.",
  "Here to handle the toil and leave you the glory.",
